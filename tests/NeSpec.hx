...
@:keep class NeSpec {
	...
	public function testNode_casts() {
		var token = uhx.mo.Token.Keyword(uhx.mo.html.Lexer.HtmlKeywords.Tag(new uhx.mo.html.Lexer.HtmlRef('a', ['b'=>'2'], [], [])));
		var node:NeNode = token;
		Assert.equals( 'a', node.nodeName );
	}
